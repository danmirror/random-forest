...
# Fungsi: Konversi satu decision tree ke C++ if-else
...
# Panggil fungsi utama dengan bebas jumlah pohon
generate_random_forest_code(df, n_trees=10)  # ganti ke 3, 5, 10, dll.
